...
// buffers, first sample must be remembered from the last buffer.
	...
	output_buffer_data[1] = output_buffer_data[0] + delta;
	output_buffer_data[2] = output_buffer_data[1] + delta;
	output_buffer_data[3] = output_buffer_data[2] + delta;
	output_buffer_data[4] = output_buffer_data[0];
	output_buffer_data[5] = output_buffer_data[1];
	output_buffer_data[6] = output_buffer_data[2];
	output_buffer_data[7] = output_buffer_data[3];
	...
	for (i=1 ; i<BUF_SIZE ; i++)
	{
		...
		output_buffer_data[i*8+1] = output_buffer_data[i*8] + delta;
		output_buffer_data[i*8+2] = output_buffer_data[i*8+1] + delta;
		output_buffer_data[i*8+3] = output_buffer_data[i*8+2] + delta;
		output_buffer_data[i*8+4] = output_buffer_data[i*8];
		output_buffer_data[i*8+5] = output_buffer_data[i*8+1];
		output_buffer_data[i*8+6] = output_buffer_data[i*8+2];
		output_buffer_data[i*8+7] = output_buffer_data[i*8+3];
